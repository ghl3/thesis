...
%The best known description of the fundamental particles and their interactions, neglecting grav- itational effects, is provided by a particular quantum field theory known as the Standard Model.
%The Standard Model
...
%many scenarios proposing new physical models.
...
%Lighter quarks are longer lived and , which makes that make the direct measurement of lighter quarks difficult.
%participate in low energy QCD processes
...
%which enable deep and precise measurements by the experiments at the LHC.
