...
Each straw has a 30 $\mu$m diameter wire at its center and is filled with a mixture of xenon gas (70\%), CO2 (20\%) and CF_{4} (10\5).
...
Energy deposits created by electrons are searched for by scanning a 5$\times$5 window of these towers, and electron candidates are seeded when the energy in the window is greater than 3 GeV.
