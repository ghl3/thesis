...
\begin{figure}[t]
\centering
\subfigure[\label{feynman_bprime}]{\includegraphics[scale=0.30]{figures/samesign/Feyn-bprime}}
\subfigure[\label{feynman_t53pair}]{\includegraphics[scale=0.30]{figures/samesign/Feyn-T53pair}}
\subfigure[\label{feynman_t53single}]{\includegraphics[scale=0.30]{figures/samesign/Feyn-T53single}}
\subfigure[\label{feynman_4t}]{\includegraphics[scale=0.30]{figures/samesign/Feyn-4t}}
...
Assuming $V_{u(c) b^\prime} << V_{t b^\prime}$, the dominant decay is $b^\prime \rightarrow t+ W^{-}$.
...
The signal is motivated by the many new physics models that couple strongly to the top quark, including interactions related to electroweak symmetry breaking, models with a composite top quark, or models with new colored, heavy particles that decay preferentially into top quarks.
...
{\sc Geant4}~\cite{Agostinelli:2002hh} interfaced with ATLAS software was used to simulate the response of the ATLAS detector,
...
\clearpage
\subsection{Results}\label{sect:interpretation}
...
These results have been interpreted in terms of several new physics models,
...
Comparing these limits to the predicted cross section as a function of the mass, as can be seen in Figure~\ref{limit:bprime},
we set a lower limit of 0.67~\TeV{} on the mass of the $b^\prime$ quark and of the $T_{5/3}$ in the case $\lambda << 1$, with an expected limit of 0.64~\TeV{}.
...
We set limits on the mass of the $T_{5/3}$ at 0.68~\TeV{} assuming a coupling constant of $\lambda=1$ and 0.70~\TeV{} for $\lambda=3$, with expected limits of 0.64~\TeV{} and 0.66~\TeV{}, respectively.
...
\begin{figure}[t]
\centering
\subfigure[\label{sig_met_ee}]{\includegraphics[scale=0.30]{figures/samesign/Signal/sig_nohtnomet_met_ee}}
\subfigure[\label{sig_ht_ee}]{\includegraphics[scale=0.30]{figures/samesign/Signal/sig_noht_ht_ee}} \\
\subfigure[\label{sig_met_em}]{\includegraphics[scale=0.30]{figures/samesign/Signal/sig_nohtnomet_met_em}}
\subfigure[\label{sig_ht_em}]{\includegraphics[scale=0.30]{figures/samesign/Signal/sig_noht_ht_em}} \\
\subfigure[\label{sig_met_mm}]{\includegraphics[scale=0.30]{figures/samesign/Signal/sig_nohtnomet_met_mm}}
\subfigure[\label{sig_ht_mm}]{\includegraphics[scale=0.30]{figures/samesign/Signal/sig_noht_ht_mm}}
