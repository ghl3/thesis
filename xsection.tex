...
Finally, Electrons must have a minimum energy of $E_{T} > 20$ GeV.
...
To measure the cross-section, the background contributions due to each of the above processes were determined using a variety of techniques.
